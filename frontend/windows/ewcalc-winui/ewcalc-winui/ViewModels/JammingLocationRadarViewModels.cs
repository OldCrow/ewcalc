...
public sealed class JammingViewModel : INotifyPropertyChanged
{
    ...
    private void ApplyOutput(JammingOutput o)
    {
        ...
        OptimumBw = o.OptimumBwStr; DutyCycle = o.DutyCycleStr; IsValid = o.Valid;
    }
...
public sealed class LocationViewModel : INotifyPropertyChanged
{
    ...
    private string _cepAoa = string.Empty, _cepEep = string.Empty;
    private bool   _isValid = false;
    ...
    { CepAoa = o.CepAoaStr; CepEep = o.CepEepStr; IsValid = o.Valid; }
