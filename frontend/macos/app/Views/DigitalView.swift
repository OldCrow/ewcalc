    ...
    var body: some View {
        Form {
            ...
            Section("Results") {
                ...
                ResultRow("Required SNR", cStr(adapter.output.required_snr_for_eb_no_str),
                          help: "Carrier SNR needed to achieve the required Eb/N₀, given the same bandwidth and data rate")
