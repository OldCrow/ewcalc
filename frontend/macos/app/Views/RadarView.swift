...
struct RadarView: View {
    ...
    private var resultsForCopy: [(label: String, value: String)] {
        [
            ("Max range",                 cStr(adapter.output.max_range_str)),
            ("Two-way loss",              cStr(adapter.output.two_way_loss_str)),
        ...
        Form {
            ...
            Section("Signal Processing") {
                InputRow("Time-BW product", unit: "", value: $timeBandwidth,
                         ...
                         error: adapter.timeBandwidthError,
                ...
                LabeledContent("Coherent pulses") {
                    HStack(spacing: 4) {
                        TextField("", value: $numPulses, format: .number)
                            ...
                            .accessibilityLabel("Coherent pulses")
                            .accessibilityValue("\(numPulses)")
                        Stepper("", value: $numPulses, in: 1...100000)
                            .labelsHidden()
                            .accessibilityLabel("Coherent pulses stepper")
